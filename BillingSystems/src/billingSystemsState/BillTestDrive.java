...
import billingSystemsSingleton.BillingSystemDBManager;
import billingSystemsFactory.Bills;
import billingSystemsCommand.Product;
...
public class BillTestDrive {
	...
	public static void main(String[] args) {
		...
		BillingSystemDBManager billingSystemDBManager = new BillingSystemDBManager();
		System.out.println("Verifying the Bill status");
		billingSystemDBManager.addBill();
		System.out.println("Bill is added and verifed");
		billingSystemDBManager.removeBill();	
		System.out.println("Bill is removed");
		 // calling Factory
		Bills bills = new Bills();
		System.out.println("Check Utility and Subscription Payement Status");
		bills.billType();	
		// calling Command
		Product product = new Product();
		System.out.println("Checking remaining products in stock");
		product.addItem();
		product.removeItem();
